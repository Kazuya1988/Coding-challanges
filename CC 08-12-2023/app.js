...
const babyShark = new Shark('Baby Shark', 5, 'Happy');
const garfield = new Cat('Garfield', 10, 'Super Happy');
const lea = new Dog('Lea', 15, 'Grumpy', 'Stefan');
console.log(babyShark);
console.log(garfield);
console.log(garfield.introduce());
console.log(lea);
console.log(lea.greetMaster());
