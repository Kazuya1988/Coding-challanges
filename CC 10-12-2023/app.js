...
//   }
// }
// const version = new vm('1.');
// console.log(version.major().release())
...
console.log(vm("").release());
console.log(vm("1.3").patch().release());
console.log(vm("1.0.2").major().minor().release());
console.log(vm("f").release());
