...
const arrNumbers = [18, 69, -90, -78, 65, 40];
const init = 0;
...
console.log(operArray(som, numbers, init));
console.log(operArray(mini, arrNumbers, arrNumbers[0]));
console.log(operArray(maxi, arrNumbers, arrNumbers[0]));
console.log(operArray(gcdi, arrNumbers, arrNumbers[0]));
