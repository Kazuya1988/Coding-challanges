...
function roomMates(rooms, floor) {
	// const startIndex = (floor - 1) * 6; // Calculate the starting index for the given floor

	// // Use the filter method to select non-empty room names on the specified floor
